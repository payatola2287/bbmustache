...
?>
<li class="item--grid item--post-<?php echo get_the_ID(); ?> layout--<?php echo $settings->posts_layout; ?>">
  ...
  <?php endif; ?>
    ...
    <figure class="wrapper--image-thumbnail">
      <img src="<?php echo $thumbnail_src; ?>" alt="<?php echo get_the_title(); ?>" class="image--thumbnail" />
    </figure>
